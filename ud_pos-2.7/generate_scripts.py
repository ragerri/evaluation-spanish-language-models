...
bl = "\\"
dir_name = "DIR_NAME='ud_pos'_${BATCH_SIZE_PER_GPU}_${WEIGHT_DECAY}_${LEARN_RATE}_$(date +'%m-%d-%y_%H-%M')"
models = [{'m':'beto'},{'m':'ixabertesv1'},{'m':'ixabertesv2'}, {'m':'ixambert'}, {'m':'mdeberta-v3-base'},{'m':'xlm-roberta-base'}, {'m':'xlm-roberta-large', 'grad':2} ]
names = {'beto':'dccuchile/bert-base-spanish-wwm-cased','ixambert':'ixa-ehu/ixambert-base-cased','ixabertesv1':'/tartalo03/users/ragerri/resources/IXABERTes_v1','ixabertesv2':'/tartalo03/users/ragerri/resources/IXABERTes_v2','mdeberta-v3-base':'microsoft/mdeberta-v3-base','xlm-roberta-base':'xlm-roberta-base', 'xlm-roberta-large':'xlm-roberta-large'}
    ...
    for batch in batches:
        ...
        for weight in weight_dec:
            for lr in learn_rate:
                with open(f"{model}_ud_pos_batch{batch}_lr{lr}_decay{weight}.sh", "w") as f:
                    f.write(f"""#!/bin/bash
SEED=42
NUM_EPOCHS=5
