...
models = [{'m':'bertin'},{'m':'electricidad'},{'m':'mbert'}]
names = {'bertin':'bertin-project/bertin-roberta-base-spanish','electricidad':'mrm8488/electricidad-base-discriminator','mbert':'bert-base-multilingual-cased'}
